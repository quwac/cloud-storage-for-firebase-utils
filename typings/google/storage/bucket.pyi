...
class Bucket(_PropertyMixin):
    ...
    def blob(self, blob_name: str, chunk_size: int = ..., encryption_key: bytearray = ..., kms_key_name: str = ..., generation: int = ...) -> Blob:
    ...
    def get_blob(self, blob_name, client=..., encryption_key=..., generation=..., timeout=..., if_generation_match=..., if_generation_not_match=..., if_metageneration_match=..., if_metageneration_not_match=..., retry=..., **kwargs):
